...
NETWORK_BLOCK_HEIGHT1=$(curl -SsL https://chainz.cryptoid.info/pivx/api.dws?q=getblockcount)
NETWORK_BLOCK_HEIGHT2=$(curl -SsL https://explorer.pivx.link/api/status?q=getInfo | jq .blockbook.bestHeight)
